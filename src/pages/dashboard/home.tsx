...
const DashboardHome = () => {
  ...
  return (
    <section className="flex flex-col items-start justify-start w-full h-full p-9">
      ...
      <section className="mt-8 w-full grid auto-rows-auto grid-cols-4 grid-flow-rows gap-4">
